...
pricingCards.forEach(card => {
    card.addEventListener('mouseenter', () => {
        card.style.transform = card.classList.contains('featured') ? 'scale(1.08)' : 'translateY(-10px) scale(1.02)';
    });
...
document.addEventListener('DOMContentLoaded', staggerFeatureCards);
