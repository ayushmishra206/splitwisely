-- SplitWisely core schema for Supabase
...
-- Profiles mirror the authenticated users table
...
-- Individual expenses captured within groups
...
-- Settlement records help track repayments
...
begin
  for table_record in
    ...
    where schemaname = 'public'
      and tablename in ('profiles', 'groups', 'group_members', 'expenses', 'expense_splits', 'settlements')
  loop
...
-- Profiles: a user can view and update their own profile
